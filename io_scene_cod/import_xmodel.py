        ...
        if mat is None:
            ...
            if load_images:
                ...
                for image_type, image_name in material.images.items():
                    ...
                    if image_type == "color":
                        cycles_textures.append([os.path.split(image_name)[1], "TS_COLOR_MAP"])

                    elif image_type == "normal":
                        cycles_textures.append([os.path.split(image_name)[1], "TS_NORMAL_MAP"])

                    elif image_type == "specular":
                        cycles_textures.append([os.path.split(image_name)[1], "TS_SPECULAR_MAP"])
